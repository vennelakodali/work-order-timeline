...
} from './timeline-hover.utils';

describe('timeline-hover utilities', () => {
  describe('isValidHoverButtonPosition', () => {
    const mockBars = [
    ...
    it('should return false when over work center column', () => {
      const result = isValidHoverButtonPosition(
  ...
  describe('clientXToTimelineX', () => {
    it('should convert client X to timeline X with scroll', () => {
      ...
      const result = clientXToTimelineX(
        clientX,
        scrollRect,
  ...
  describe('isOverEmptySpace', () => {
    ...
    it('should handle single bar', () => {
      ...
      expect(isOverEmptySpace(50, singleBar)).toBe(true);   // before
      expect(isOverEmptySpace(125, singleBar)).toBe(false); // inside
      expect(isOverEmptySpace(200, singleBar)).toBe(true);  // after
    });
  });
  ...
  describe('isCursorOutsideButtonBounds', () => {
    ...
    it('should return false when cursor is at button center', () => {
      const result = isCursorOutsideButtonBounds(
  ...
  describe('calculateButtonPosition', () => {
    it('should position button at mouse X and row vertical center', () => {
      ...
      const result = calculateButtonPosition(mouseEvent, rowRect);
    ...
    it('should ignore mouse Y coordinate', () => {
      ...
      const result1 = calculateButtonPosition(mouseEvent1, rowRect);
      const result2 = calculateButtonPosition(mouseEvent2, rowRect);
